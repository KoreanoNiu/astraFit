<?php 
                        ...
                        if($data > 0){
                            $template = '
                            <div class="img-user now">
                                <div class="header-img">
                                    <h2>20:33 0/11/2020</h2>
                                    <div class="delete-img">
                                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" onclick="eliminarFoto("../users/uploads-progress-images/5f9f6ff36a491.jpg", "20:33 0/11/2020")">
                                ...
                                <img src="users/uploads-progress-images/5f9f6ff36a491.jpg">
                            </div>';
                            ...
                            echo '<form id="frmImage" onsubmit="return false">
                            <div class="photoSelectButton">
                                <div class="photoInput">
                                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="0 0 419.2 419.2" style="enable-background:new 0 0 419.2 419.2;" xml:space="preserve">
